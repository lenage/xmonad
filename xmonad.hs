...
-- Options
{-# LANGUAGE DeriveDataTypeable, NoMonomorphismRestriction, MultiParamTypeClasses, ImplicitParams, TypeSynonymInstances, FlexibleContexts #-}
...
boxLeftIcon    = "/home/ox66/.icons/xbm_icons/boxleft.xbm"  --left icon of dzen boxes
boxLeftIcon2   = "/home/ox66/.icons/xbm_icons/boxleft2.xbm" --left icon2 of dzen boxes
boxRightIcon   = "/home/ox66/.icons/xbm_icons/boxright.xbm" --right icon of dzen boxes
...
calendarCA :: CA
calendarCA = CA
	{ leftClickCA   = "/home/ox66/bin/dzencal.sh"
	, middleClickCA = "/home/ox66/bin/dzencal.sh"
	, rightClickCA  = "/home/ox66/bin/dzencal.sh"
	, wheelUpCA     = "/home/ox66/bin/dzencal.sh"
	, wheelDownCA   = "/home/ox66/bin/dzencal.sh"
	}
...
myStartupHook =
	...
	(spawn "/usr/bin/feh --bg-scale /home/ox66/.wallpapers/a.png") <+>
	...
	-- (spawn "/home/ox66/.xmonad/apps/haskell-cpu-usage.out 5") <+>
...
myBotRightLogHook h = dynamicLogWithPP defaultPP
	...
	, ppOrder  = \(_:_:_:x) -> x
	, ppSep    = " "
	, ppExtras = [ myCpuL, myMemL, myTempL]
	}
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
	...
	, ((0, xF86XK_AudioMute), spawn "/home/ox66/bin/voldzen.sh t -d")                                                   --Mute/unmute volume
	, ((0, xF86XK_AudioRaiseVolume), spawn "/home/ox66/bin/voldzen.sh + -d")                                            --Raise volume
	, ((mod1Mask, xK_Up), spawn "/home/ox66/bin/voldzen.sh + -d")
	, ((0, xF86XK_AudioLowerVolume), spawn "/home/ox66/bin/voldzen.sh - -d")                                            --Lower volume
	, ((mod1Mask, xK_Down), spawn "/home/ox66/bin/voldzen.sh - -d")
	...
	, ((0, xF86XK_ScreenSaver), spawn "/home/ox66/bin/turnoffscreen.sh")                                                --Lock screen
	, ((0, 0xff14), spawn "/home/ox66/bin/turnoffscreen.sh")
	, ((0, xK_Print), spawn "/usr/bin/scrot '%Y-%m-%d_$wx$h.png'" >> flashText myTextConfig 1 " Screenshot Saved ")       --Take a screenshot
	, ((modMask , xK_s), spawn "/home/ox66/bin/turnoffscreen.sh")                                                       --Turn off screen
